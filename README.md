...
1. 支付宝撤销订单接口 (800105) 即使是已完成的订单也会撤销**并退款**.
2. 微信关闭订单接口 (800205) 只会关闭未完成的订单.
...
| txamt        | 交易金额                |      | 2016-08-21 11:00:00                               |
| txdtm        | 交易时间                |      | 1                                                 |
| respcd       | 交易状态码              |      | 0000                                              |
| respmsg      | 交易结果文字描述        |      | 2016-08-01 11:00:00                               |
