...
- POST
    ...
    | 参数名       | 描述                                                              | 是否必填 | 备注                                                        | 示例                |
    |--------------|-------------------------------------------------------------------|----------|-------------------------------------------------------------|---------------------|
    | mchid        | signup 接口返回的 mchid                                           |          | 若填写则使用对应的子商户, 不填则使用主商户号                | BvDtmKJA5mx7GpN0    |
    ...
    | txcurrcd     | 货币, 必填                                                        | 必填     | 遵循 ISO-4217 标准的 3 位英文编码, 如人民币: CNY, 港币: HKD | CNY                 |
    | udid         | 设备唯一标示                                                      |          |                                                             |                     |
    | openid       |                                                                   |          |                                                             |                     |
    | sub_openid   |                                                                   |          |                                                             |                     |
...
- POST
    ...
    | txdtm        | 创建订单时使用的 txdtm        | 必填                         |                                              | 2016-08-01 11:07:22      |
    | txamt        | 订单金额                      | 必填                         |                                              | 10                       |
    | udid         | 设备唯一标示                  |                              |                                              |                          |
...
- POST
    ...
    | out_trade_no | 创建订单时使用的 out_trade_no | 必填     |                                              | 1470020842103            |
    | txdtm        | 创建订单时使用的 txdtm        | 必填     |                                              | 2016-08-01 11:07:22      |
    | txamt        | 订单金额                      | 必填     |                                              | 10                       |
    | udid         | 设备唯一标示                  |          |                                              |
